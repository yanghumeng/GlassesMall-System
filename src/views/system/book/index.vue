<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="bookList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="图书库存" align="center" prop="inventory" />
      <el-table-column label="图书编码" align="center" prop="bookCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="图书库存" prop="inventory">
          <el-input v-model="form.inventory" placeholder="请输入图书库存" />
        </el-form-item>
        <el-form-item label="图书编码" prop="bookCode">
          <el-input v-model="form.bookCode" placeholder="请输入图书编码" />
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        ...
        <el-dialog :title="title" :visible.sync="open1" width="500px" append-to-body>
          <el-form ref="form" :model="form" :rules="rules" label-width="80px">
            ...
            <el-form-item label="借阅人" prop="name">
              <el-input v-model="form.name" placeholder="请输入图书编码" />
            </el-form-item>
            <el-form-item label="借出数量" prop="count">
              <el-input v-model="form.count" placeholder="请输入图书编码" />
            </el-form-item>
          </el-form>
          <div slot="footer" class="dialog-footer">
        ...
        <el-dialog :title="title" :visible.sync="open2" width="500px" append-to-body>
          <el-form ref="form" :model="form" :rules="rules" label-width="80px">
            ...
            <el-form-item label="归还数量" prop="count">
              <el-input v-model="form.count" placeholder="请输入图书编码" />
            </el-form-item>
          </el-form>
          <div slot="footer" class="dialog-footer">
