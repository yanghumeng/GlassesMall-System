<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="系列图" align="center" prop="url">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="系列图" prop="url">
          <el-upload
          ...
          >
            <img v-if="url" :src="form.url" class="avatar" />
  ...
  methods: {
    ...
    uploadSuccess(res, file) {
      ...
      if (res.code === 200) {
        ...
        this.url = res.imagesUrl;
        this.queryParams.picture = res.imagesUrl;
        this.form.url = res.imagesUrl;
      }
    },
    /** 查询系列列表 */
    getList() {
